...
// Copies fontawsome assets to dist
gulp.task('fontawesome', function () {
    return gulp.src('src/assets/fontawesome/**/*')
        .pipe(gulp.dest('dist/assets/fontawesome/'));
});
...
gulp.task('script-libs', function () {
    return gulp.src('src/assets/js/libs/*')
...
gulp.task('default', ['clean:dist', 'scripts', 'images', 'compile-html', 'resetPages', 'fontawesome', 'font', 'script-libs', 'watch']);

// Creates production ready assets in dist folder
gulp.task('build', function () {
    console.log('Building production ready assets');
    runSequence('clean:dist', 'sass', ['scripts', 'images','fontawesome', 'font', 'script-libs', 'compile-html'])
});
